...
'reaction_list_ptr': {'offset': 0x160, 'size': 8},
    'reaction_list_size': {'offset': 0x170, 'size': 8},
    'requirements_ptr': {'offset': 0x178, 'size': 8},
    'requirement_count': {'offset': 0x180, 'size': 8},
    'hit_conditions_ptr': {'offset': 0x188, 'size': 8},
    'hit_conditions_size': {'offset': 0x190, 'size': 8},
    'projectile_ptr': {'offset': 0x198, 'size': 8},
    'projectile_size': {'offset': 0x1A0, 'size': 8},
    'pushback_ptr': {'offset': 0x1A8, 'size': 8},
    'pushback_list_size': {'offset': 0x1B0, 'size': 8},
    'pushback_extradata_ptr': {'offset': 0x1B8, 'size': 8},
    'pushback_extradata_size': {'offset': 0x1C0, 'size': 8},
    'cancel_head_ptr': {'offset': 0x1C8, 'size': 8},
    'cancel_list_size': {'offset': 0x1D0, 'size': 8},
    'group_cancel_head_ptr': {'offset': 0x1D8, 'size': 8},
    'group_cancel_list_size': {'offset': 0x1E0, 'size': 8},
    'cancel_extradata_head_ptr': {'offset': 0x1E8, 'size': 8},
    'cancel_extradata_list_size': {'offset': 0x1F0, 'size': 8},
    'extra_move_properties_ptr': {'offset': 0x1F8, 'size': 8},
    'extra_move_properties_size': {'offset': 0x200, 'size': 8},
    'move_start_props_ptr': {'offset': 0x208, 'size': 8},
    'move_start_props_size': {'offset': 0x210, 'size': 8},
    'move_end_props_ptr': {'offset': 0x218, 'size': 8},
    'move_end_props_size': {'offset': 0x220, 'size': 8},
    'movelist_head_ptr': {'offset': 0x228, 'size': 8},
    'movelist_size': {'offset': 0x230, 'size': 8},
    'voiceclip_list_ptr': {'offset': 0x238, 'size': 8},
    'voiceclip_list_size': {'offset': 0x240, 'size': 8},
    'input_sequence_ptr': {'offset': 0x248, 'size': 8},
    'input_sequence_size': {'offset': 0x250, 'size': 8},
    'input_extradata_ptr': {'offset': 0x258, 'size': 8},
    'input_extradata_size': {'offset': 0x260, 'size': 8},
    'unknown_parryrelated_list_ptr': {'offset': 0x268, 'size': 8},
    'unknown_parryrelated_list_size': {'offset': 0x270, 'size': 8},
    'throw_extras_ptr': {'offset': 0x278, 'size': 8},
    'throw_extras_size': {'offset': 0x280, 'size': 8},
    'throws_ptr': {'offset': 0x288, 'size': 8},
    'throws_size': {'offset': 0x290, 'size': 8},
    'dialogues_ptr': {'offset': 0x298, 'size': 8},
    'dialogues_size': {'offset': 0x2A0, 'size': 8},

    'mota_start': {'offset': None, 'size': 8},
    # 120 aliases
    'original_aliases': {'offset': 0x30, 'size': (57, 2)},
    'current_aliases': {'offset': 0xA2, 'size': (57, 2)},
    # 36 aliases
    'unknown_aliases': {'offset': 0x114, 'size': (36, 2)},
    ...
    'move:hit_level': {'offset': 0x24, 'size': 4},
    ...
    'move:cancel1_addr': {'offset': 0x30, 'size': 8},
    ...
    'move:_0xCE': {'offset': 0x5E, 'size': 2},
    'move:_0xD0': {'offset': 0x60, 'size': 4},
    ...
    'move:_0x118': {'offset': 0x70, 'size': 4},
    'move:_0x11C': {'offset': 0x74, 'size': 4},
    'move:anim_max_len': {'offset': 0x78, 'size': 4},
    'move:airborne_start': {'offset': 0x7C, 'size': 4},
    'move:airborne_end': {'offset': 0x80, 'size': 4},
    'move:ground_fall': {'offset': 0x84, 'size': 4},
    ...
    'move:_0x154': {'offset': 0xAC, 'size': 4},
    'move:startup': {'offset': 0xB0, 'size': 4},
    'move:recovery': {'offset': 0xB4, 'size': 4},
    'move:hitbox1_startup': {'offset': 0xB8, 'size': 4},
    'move:hitbox1_recovery': {'offset': 0xBC, 'size': 4},
    'move:hitbox1': {'offset': 0xC0, 'size': 4},
    'move:hitbox1_related_floats': {'offset': 0xC4, 'size': (8, 4)},
    'move:hitbox2_startup': {'offset': 0xE4, 'size': 4},
    'move:hitbox2_recovery': {'offset': 0xE8, 'size': 4},
    'move:hitbox2': {'offset': 0xEC, 'size': 4},
    'move:hitbox2_related_floats': {'offset': 0xF0, 'size': (8, 4)},
    'move:hitbox3_startup': {'offset': 0x110, 'size': 4},
    'move:hitbox3_recovery': {'offset': 0x114, 'size': 4},
    'move:hitbox3': {'offset': 0x118, 'size': 4},
    'move:hitbox3_related_floats': {'offset': 0x11C, 'size': (8, 4)},
    'move:hitbox4_startup': {'offset': 0x13C, 'size': 4},
    'move:hitbox4_recovery': {'offset': 0x140, 'size': 4},
    'move:hitbox4': {'offset': 0x144, 'size': 4},
    'move:hitbox4_related_floats': {'offset': 0x148, 'size': (8, 4)},
    'move:hitbox5_startup': {'offset': 0x168, 'size': 4},
    'move:hitbox5_recovery': {'offset': 0x16C, 'size': 4},
    'move:hitbox5': {'offset': 0x170, 'size': 4},
    'move:hitbox5_related_floats': {'offset': 0x174, 'size': (8, 4)},
    'move:hitbox6_startup': {'offset': 0x194, 'size': 4},
    'move:hitbox6_recovery': {'offset': 0x198, 'size': 4},
    'move:hitbox6': {'offset': 0x19C, 'size': 4},
    'move:hitbox6_related_floats': {'offset': 0x1A0, 'size': (8, 4)},
    'move:hitbox7_startup': {'offset': 0x1C0, 'size': 4},
    'move:hitbox7_recovery': {'offset': 0x1C4, 'size': 4},
    'move:hitbox7': {'offset': 0x1C8, 'size': 4},
    'move:hitbox7_related_floats': {'offset': 0x1CC, 'size': (8, 4)},
    'move:hitbox8_startup': {'offset': 0x1EC, 'size': 4},
    'move:hitbox8_recovery': {'offset': 0x1F0, 'size': 4},
    'move:hitbox8': {'offset': 0x1F4, 'size': 4},
    'move:hitbox8_related_floats': {'offset': 0x1F8, 'size': (8, 4)},
    'move:u16': {'offset': 0x218, 'size': 2},
    'move:u17': {'offset': 0x21A, 'size': 2},
    'move:unk5': {'offset': 0x21C, 'size': (88, 4)},
